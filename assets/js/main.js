...
// Complete French/Spanish version of Juliana's invitation.
t_onReady(function() {
  var translations = {
    fr: {
      title: 'Le Quinceañero de Juliana | 17 octobre 2026',
      description: 'Invitation au Quinceañero de Juliana, le samedi 17 octobre 2026 à Vauhallan.',
      languageLabel: 'Choisir la langue',
      open: 'Appuyez pour ouvrir',
      age: 'Quinceañero',
      date: 'Samedi 17 octobre 2026',
      time: 'de 19 h à 2 h',
      invitation: '<strong>Belisario Robles et Pilar Rincones</strong><br><br>ont le plaisir de vous inviter à célébrer<br><strong>le Quinceañero de Juliana</strong>.<br><br>Samedi 17 octobre 2026<br>de 19 h à 2 h<br><br>Salle Polyvalente de Vauhallan',
      ...
      scheduleItems: ["Accueil des invités", "Entrée de Juliana", "Changement de chaussures et vals père-fille", "Que la fête commence"],
      location: 'Lieu',
      ...
      giftsCopy: 'Votre présence sera le plus précieux des cadeaux pour Juliana.<br><br>Et si vous souhaitez lui faire plaisir davantage, une « lluvia de sobres » sera délicatement appréciée.<br><br>Le plus important reste de partager avec elle cette soirée si particulière.',
    ...
    es: {
      title: 'El Quinceañero de Juliana | 17 de octubre de 2026',
      description: 'Invitación al Quinceañero de Juliana, el sábado 17 de octubre de 2026 en Vauhallan.',
      languageLabel: 'Elegir idioma',
      open: 'Pulsa para abrir',
      age: 'Quinceañero',
      date: 'Sábado 17 de octubre de 2026',
      time: 'de 19:00 a 2:00',
      invitation: '<strong>Belisario Robles y Pilar Rincones</strong><br><br>tienen el placer de invitarte a celebrar<br><strong>el Quinceañero de Juliana</strong>.<br><br>Sábado 17 de octubre de 2026<br>de 19:00 a 2:00<br><br>Salle Polyvalente de Vauhallan',
      ...
      scheduleItems: ['Recepción de invitados', 'Entrada de la Quinceañera', 'Cambio de zapatillas y Vals padre e hija', 'Que comience la fiesta'],
      location: 'Lugar',
      ...
      giftsCopy: 'Tu presencia será el regalo más especial para Juliana.<br><br>Y si deseas hacerle un detalle adicional, una «lluvia de sobres» será recibida con mucho cariño.<br><br>Lo más importante es compartir juntos esta noche tan especial.',
  ...
  function applyLanguage(language, updateUrl) {
    ...
    setText('rec2339662063', '1779566247730000001', 'Juliana<br><span class="hero-age">' + copy.age + '</span>');
    ...
    setText('rec2339662083', '1779472210551000005', 'Juliana');
    ...
    setText('rec2355511493', '1780760554668000006', '20:00');
    setText('rec2355511493', '1780760554668000008', '21:00');
    ...
    var giftNote = document.querySelector('#rec2355542373 .gift-note');
    if (!giftNote) {
      var giftArtboard = document.querySelector('#rec2355542373 .t396__artboard');
      if (giftArtboard) {
        giftNote = document.createElement('p');
        giftNote.className = 'gift-note';
        giftArtboard.appendChild(giftNote);
      }
    }
    if (giftNote) giftNote.innerHTML = copy.giftsCopy;
